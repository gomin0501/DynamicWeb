...
<%
	...
	try{
		String sql="select to_char(orderdate,'yyyy-mm-dd'),ordername,a.productid,a.name,b.unitprice,orderqty,orderaddress from product2024 a,order0312 b where a.productid=b.productid";
