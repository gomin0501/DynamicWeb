...
<%
	...
	try{
		...
		String sql="select a.productid,to_char(orderdate,'yyyy-mm-dd'),ordername,b.name,a.unitprice,b.unitinstock,orderqty,orderaddress from order0312 a, product2024 b where a.productid=b.productid and a.productid=? ";
